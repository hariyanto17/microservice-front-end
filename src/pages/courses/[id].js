...
const DetailsCourse = ({data}) => {
    ...
    return (
        <>
            ...
            <section className="pt-10 relative overflow-hidden" style={{height:600}}>
                ...
                <div className="w-3/4 mx-auto mt-8">
                    <div className="w-3/4">
                        ...
                        <section>
                            ...
                            <p className="text-gray-600 text-lg landing-relaxed mb-3">
                                {data?.description ?? "No Description Fount"}
                            </p>
                        </section>

                        {/* Courses Photos Preview*/}
                            ...
                            <div className="flex justify-start items-center -mx-4 mt-6">
                                {
                                    ...
                                    data.images.map((photo, index) => <CoursePhoto data={photo.image} key={index} ></CoursePhoto> )
                        ...
                        <section className="mt-10">
                            ...
                            </h6>
                            {
                                ...
                                : <div className="w-full text-center py-21">No Chapters Found</div>
                            }
                        </section>
                        ...
                        <section className="mt-10 w-2/3">
                            <h6 className="font-medium text-gray-900 text-2xl mb-4">
                                Our <span className="text-teal-500">Instruktor</span>
                            </h6>
                            <div className="flex item-center">
                                <img className="w-20 h-20 rounded-full overflow-hidden object-cover " src={data?.mentor?.profile ?? ""} alt={data?.mentor?.name}/>
                            </div>
                            <div className="ml-4" >
                                <h2 className="text-lg text-gray-900 ">{data?.mentor?.name}</h2>
                                <h3 className="text-sm text-gray-600">{data?.mentor?.profession}</h3>
                            </div>
                        </section>
